...
export default function ResetPasswordPage() {
  ...
  useEffect(() => {
    const checkSession = async () => {
      ...
      if (!session) setSessionInvalid(true)
    }
    checkSession()
  }, [supabase.auth])
  ...
  const inputContainerStyle = (f: string, invalid?: boolean, valid?: boolean) => ({
    borderRadius: 12,
        ...
        <AnimatePresence mode="wait" initial={false}>
          ...
          {sessionInvalid ? (
            ...
            >
              ...
              <h2 style={{ fontSize: 18, fontWeight: 900, color: dark ? '#f1f5f9' : '#0f172a', marginBottom: 10 }}>
                Link expired
              </h2>
              <p style={{ fontSize: 13, color: dark ? '#64748b' : '#94a3b8', lineHeight: 1.6, marginBottom: 24 }}>
            ...
            >
              ...
              >
                <div style={{
                  ...
                  <ShieldCheck size={34} weight="fill" color="#3b82f6" />
                </div>
              </motion.div>
              ...
              <motion.p
                ...
                style={{ fontSize: 13, color: dark ? '#64748b' : '#94a3b8', lineHeight: 1.65, marginBottom: 28 }}
              >
            ...
            >
              ...
              >
                ...
                <motion.div variants={row}>
                  ...
                  <div style={inputContainerStyle('confirm', passwordsMismatch, passwordsMatch)}>
                    <input
