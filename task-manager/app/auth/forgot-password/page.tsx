    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[400px]">
          ...
          {sent ? (
            ...
            >
              ...
              >
                <div style={{
                  ...
                  background: dark ? 'rgba(37,99,235,0.12)' : 'rgba(219,234,254,0.7)',
                  border: dark ? '1px solid rgba(59,130,246,0.25)' : '1px solid rgba(147,197,253,0.6)',
                  boxShadow: '0 8px 28px rgba(37,99,235,0.2), inset 0 1px 0 rgba(255,255,255,0.1)',
              ...
              <motion.p
                ...
                style={{ fontSize: 13, color: dark ? '#64748b' : '#94a3b8', lineHeight: 1.65, marginBottom: 8 }}
              >
              ...
              <motion.p
                ...
                style={{
                  ...
                  padding: '8px 14px',
                  borderRadius: 10,
                  background: dark ? 'rgba(59,130,246,0.08)' : 'rgba(219,234,254,0.5)',
                  border: dark ? '1px solid rgba(59,130,246,0.15)' : '1px solid rgba(147,197,253,0.4)',
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    fontSize: 12, color: dark ? '#475569' : '#94a3b8',
                    padding: '6px 0',
                  }}
            ...
            >
              ...
              <motion.p
                ...
                style={{
                  fontSize: 13, color: dark ? '#475569' : '#94a3b8',
                  ...
                  <div style={{
                    ...
                    <input
                      ...
                      style={{
                        ...
                        color: dark ? '#e2e8f0' : '#1e293b', borderRadius: 12,
                      }}
                    />
                  </div>
                </motion.div>
        ...
        <motion.p
          ...
          style={{ textAlign: 'center', fontSize: 12, marginTop: 20, color: dark ? '#475569' : '#94a3b8', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 4 }}
        >
          <ArrowLeft size={12} weight="bold" />
          <Link href="/auth/login" style={{ color: dark ? '#64748b' : '#94a3b8', fontWeight: 600, textDecoration: 'none' }} className="hover:text-blue-500 transition-colors">
            Back to Login
          </Link>
        </motion.p>
      </div>
