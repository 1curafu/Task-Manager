...
-- This script:
-- 1. Adds the 'completed' column to Task table
-- 2. Updates all existing RLS policies
...
-- ============================================================
-- STEP 2: Drop ALL existing Task policies
-- ============================================================
...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE '1. Added "completed" column to Task table';
    RAISE NOTICE '2. Updated all existing tasks to completed = false';
    RAISE NOTICE '3. Created 4 RLS policies:';
    RAISE NOTICE '   - Users can view accessible tasks (SELECT)';
    RAISE NOTICE '   - Users can create tasks (INSERT)';
    RAISE NOTICE '   - Users can update tasks (UPDATE)';
    RAISE NOTICE '   - Users can delete own created tasks (DELETE)';
    RAISE NOTICE '';
